...
class TestMixHelper(TestCase):
    ...
    def test_mix_with_mix_base_url(self):
        ...
        self._make_manifest()
        self.assertEqual(
            mix.url("storage/app.css"), "https://some-cdn.com/static/app.css"
        )
