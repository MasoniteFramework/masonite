    ...
    def handle(self):
        ...
        try:
            if repo:
                ...
                if provider == "github":
                    # master branch is cloned by default
                    zipball = "https://{}.com/{}/archive/master.zip".format(provider, repo)
                else:
                    raise NotImplementedError("Crafting project from this repo provider is not implemented yet.")
