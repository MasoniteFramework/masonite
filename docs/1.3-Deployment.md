Larapy focuses on easy development and fast deployment. Larapy is setup to easily deploy to Heroku by default and currently only supports Heroku for fast deployment. Future drivers will be added.
