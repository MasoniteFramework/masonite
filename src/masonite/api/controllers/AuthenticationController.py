...
class AuthenticationController(Controller):
    ...
    def auth(self, auth: Auth, request: Request, response: Response):
        ...
        return response.json({"message": "Could not find username or password"}, status="403")
    ...
    def reauth(self, request: Request, response: Response):
        ...
        return response.json({"message": "Could not reauthenticate based on given token."}, status="403")
